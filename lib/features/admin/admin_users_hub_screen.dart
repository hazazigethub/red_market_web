...
/// قسم العملاء والتجار
class AdminUsersHubScreen extends StatefulWidget {
  const AdminUsersHubScreen({super.key});

  @override
  State<AdminUsersHubScreen> createState() => _AdminUsersHubScreenState();
}
                  ...
                  child: LayoutBuilder(
                    builder: (context, c) {
                      ...
                      final tabs = Row(
                        ...
                        children: [
                          _tabChip(
                              0, 'العملاء', Icons.person_search_outlined),
                          const SizedBox(width: 10),
                          _tabChip(1, 'التجار', Icons.storefront_outlined),
                        ],
                      );
              ...
              child: Center(
                child: ConstrainedBox(
                  ...
                  child: IndexedStack(
                    index: _tab,
                    children: [
                      AdminUsersScreen(searchQuery: _query),
                      AdminMerchantsScreen(searchQuery: _query),
                    ],
                  ),
                ),
              ),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: _tab == 0
              ...
              : 'ابحث باسم المتجر أو الإيميل',
          hintStyle: TextStyle(
              fontFamily: 'Cairo',
              fontSize: 12.5,
              color: Colors.grey.shade400),
          prefixIcon:
              Icon(Icons.search_rounded, size: 19, color: Colors.grey.shade500),
